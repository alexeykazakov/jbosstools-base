...
public class GlobalUsageSettingsForEventRegisterTest extends GlobalUsageSettings {
	...
	@Override
	protected IPropertiesProvider createRemoteMap(String url, char valueDelimiter, Plugin plugin, String... keys) {
...
//		return super.createRemoteMap(url, valueDelimiter, plugin, keys);
	}
