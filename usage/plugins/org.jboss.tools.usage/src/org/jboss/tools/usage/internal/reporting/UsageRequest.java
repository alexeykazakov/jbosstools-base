...
//	synchronized public boolean sendCountEventRequest(String pagePath,
//			String title,
//			UsageEvent event,
//			RequestType type,
//			boolean startNewVisitSession) {
...
//			}
//		}
//		EventRegister.Result result = getEventRegister().checkTrackData(event, settings);
...
//			if(!onceADayOnly || value>0) {
//				String url = createUrl(environment, pagePath, title, event, type, startNewVisitSession);
//				sent = sendRequest(environment, url);
//			}
//		}
//		return sent;
//	}
